...
#######################################################################
message("Cades GPU Condo is local only")
...
if (PYCICLE_COMPILER_TYPE MATCHES "gcc")
  ...
  set(CUDA_DIR         "/software/user_tools/centos-7.2.1511/cades-cnms/spack/opt/spack/linux-centos7-x86_64/gcc-5.3.0/cuda-9.1.85-pug3iefofxk5mylifjczqcyyhkgyp2ui")
  set(MAGMA_DIR         "/software/user_tools/centos-7.2.1511/cades-cnms/spack/opt/spack/linux-centos7-x86_64/gcc-5.3.0/magma-2.2.0-v5jfj24io4lruq7ikirnc3eoraxj6xvq")
  # multiline string
